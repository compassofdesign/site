...
$(document).ready(function(){
	...
	if(window.location.href.indexOf("results") > -1) {
		...
		if (s1a >= .85) {
			s1a = "Skilled";
			action[0].prepend('You sit at a unique stage in your life where you have a lot of experience under your belt. Many could benefit from that, and you could start helping the designers for the new decade shine. We all grow together, and the more people we have like you, the better.')
		} else if (s1a >= .70) {
			s1a = "Proficient";
			action[0].prepend('Open yourself up to helping others who are just starting out find information on ways they could improve. You have a unique advantage where sharing what you know now will help you solidify your skills. Both you and other benefit. Go to local meetups, get in an online community like the <a href="https://compassofdesign.com/community">Compass of Design Community</a>')
		} else if (s1a >= .60) {
			s1a = "Competent";
			action[0].prepend('Get around people in your industry and make some connections. You can do so online like the <a href="https://compassofdesign.com/community">Compass of Design Community</a> or through other channels like local meetups or conferences.')
		} else {
			s1a = "Beginner";
			action[0].prepend('Start getting the information you need to look up design topics. Medium.com, DesignerNews.co, or <a href=\"https://medium.com/compass-of-deisgn\">even our articles</a> can help. Find a few great books, like Michael Beirut\'s \"How to\" book, or Thinking with type by Ellen Lupton. You can even go to the <a href=\"https://compassofdesign.com/community\">Compass of Design Community</a> to get help.')
		}
		if (s2a >= .85) {
			s2a = "Skilled";
			action[1].prepend('You have a lot of these down pat, congrats! That isn\'t the easiest thing to do. Our steps for you are to start understanding the psychology and theories on how design makes people think or act certain ways. Why hospitals are more trustworthy if the walls are white and squeaky clean vs. a dirty / grimy hospital. People have perceptive abilities to learn from what they visually see. It is the same with design. You can do a lot of good in the world with good design.');
		} else if (s2a >= .70) {
			s2a = "Proficient";
